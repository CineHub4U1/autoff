...
BOT_TOKEN = environ.get('BOT_TOKEN', '6211750585:AAE07M-GxPAtIq9GMnO5Ay3Ov11-ohqYDWs')
# Bot settings
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '911789995').split()]
